...
## Що можна розповісти на співбесіді

- Я зробив повноцінне рішення навколо Cloudflare:
  - Telegram‑бот з whitelist доступом і командами для доменів + DNS.
  - Backend на Express/TypeScript з нормальними шарами: конфіг, модулі, middleware.
  - Frontend‑адмінку на React + Ant Design для управління whitelist.
- Все конфігуроване через `.env`, секрети не світяться в репозиторії.
- Архітектура така, щоб проект можна було легко розширювати (нові команди бота, нові ендпоінти, додаткові сторінки у фронті).
